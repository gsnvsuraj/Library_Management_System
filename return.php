...
<body>
    ...
    <li><a class="college">NIT Puducherry Library</a></li>
      ...
      <li><a class="active" href="listRet.php">Return</a></li>
	...
	<?php
			...
			$sql = "SELECT * FROM assign WHERE id = '".$book."' and user = '".$_SESSION['user']."';";
			$res = $conn->query($sql) or die(mysqli_error($conn));

			if (mysqli_num_rows($res) > 0) {
				$row = mysqli_fetch_array($res);

				$sql = "DELETE FROM assign WHERE id = '".$book."' and user = '".$_SESSION['user']."';";
				$res = $conn->query($sql) or die(mysqli_error($conn));
    			...
    			echo $row['name']." book is deleted from your list.";
			} else {
			    echo "<h2><center>No such book available in your list.</center></h2>";
			}
